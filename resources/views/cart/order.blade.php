    ...
    <table border="1"  class="table table-bordered">
        ...
        @foreach($deta as $v)
            <tr o_id="{{$v['o_id']}}">
                ...
                <td><a class="btn btn-warning del_order" >取消订单1</a><a href="/order/orderdel/{{$v['o_id']}}"><font color="red" class="btn btn-info">取消订单</font></a> <a href="/pay/order/{{$v['o_id']}}"><font color="#ffd700">立即支付</font></a></td>
            </tr>
        @endforeach
        </tbody>
    </table>
